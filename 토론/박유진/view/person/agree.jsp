...
<script src="../js/person/agree.js" ></script>
...
<body background="./back.jpg">
	<form name="form1">
		<table align="center">
			<tr>
				<td><font size="5" style="">약관동의
						<hr>
				</font></td>
			</tr>
			<tr>
				<td><textarea rows="15" cols="75" id="agree11"
						disabled="disabled">제 1조 (목 적)

이 서비스 이용약관(이하 “약관”이라 합니다)은 토론트㈜(이하 “회사”라 합니다)가 제공하는 서비스와 관련하여 회사와 이용 고객(또는 회원) 간에 서비스의 이용 조건 및 절차, 회사와 회원 간의 권리, 의무 및 책임 사항 기타 필요한 사항을 규정함을 목적으로 합니다.
...
4)회원정보 : 회사가 이용고객에게 회원가입 신청양식(이하 “신청양식"이라 합니다)에 기재를 요청하는 이용고객의 개인정보를 말합니다.
			...
			<tr>
				<td>첫번째 약관에 동의합니다<input type="checkbox" name="agree1" id="cb1"
					value="agree1"></td>
			</tr>
			<tr>
				<td><textarea rows="15" cols="75" id="agree22"
						disabled="disabled">제 3 조 (약관의 효력 및 변경)
...
7)회원은 약관의 변경에 대하여 주의의무를 다하여야 하며, 변경된 약관의 부지로 인한 회원의 피해는 회사가 책임지지 않습니다.
			...
			<tr>
				<td>두번째 약관에 동의합니다.<input type="checkbox" id="cb2" name="agree2"
					value="agree2"></td>
			</tr>
			<tr>
				<td>전체 내용에 동의합니다.<input type="checkbox" id="checkall"
					name="checkall">
					<hr></td>
			</tr>
			...
			<tr>
				<td><input type="button" value="동의함" align="top"
					class="btn btn-default right" id="agreeBtn" name="agreeBtn" /> <input
					type="button" id="noagreeBtn" value="동의하지 않음" align="top"
					class="btn btn-default right" /></td>
			</tr>
		</table>
	</form>
